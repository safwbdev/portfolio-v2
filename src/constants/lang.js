...
// PROFILE
export const PROFILE_LOADING = "Just a moment...";
...
export const SKILL_LIBRARIES = "Libraries";
export const SKILL_DATABASES = "Database";
export const SKILL_CMS = "Content Management Systems";
